  ...
  <section class="w3l-grids-3 py-5">
    <div class="container py-md-3">
      <div class="title-content text-left mb-lg-5 mb-4">
        <h6 class="sub-title">Flight booking</h6>
        <h4 class="hny-title">The Flights in the Route: ${fromAirport} to ${toAirport}</h4>
      </div>
      <div class="container py-md-6">
        ...
        <div class="flight-container">
           <div class="flight-detail">
            <img src="${flight.imageUrl}" alt="Airline Logo">
        ...
        <div class="flight-route">${toAirport}</div>
        <div class="flight-price">₹ ${fair}</div>
          
        <a href="/ticket/${flight.flightNumber}" class="book-btn">Booking</a>
        </div>
        </c:forEach>
      </div>
